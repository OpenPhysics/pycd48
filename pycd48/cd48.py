...
class CD48:
    ...
    def get_counts(self, human_readable=True):
        """
    ...
    def set_channel(self, channel, A=0, B=0, C=0, D=0):
        """
    ...
    def set_impedance_50ohm(self):
        """Set input impedance to 50 Ohms"""
        return self._send_command('z')

    def set_impedance_highz(self):
        """Set input impedance to high-Z"""
        return self._send_command('Z')

    def set_repeat(self, interval_ms):
        """
    ...
    def get_settings(self, human_readable=True):
